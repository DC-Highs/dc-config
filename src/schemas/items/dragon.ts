...
const elementMap: Record<string, DragonElement> = {
...
export const dragonSchema = z.object({
    ...
    return {
        ...
        elements: data.attributes.map((element) => elementMap[element]),
        description: data.description,
        description_key: data.description ? `tid_unit_${data.id}_description` : null,
        ...
        timers: {
            hatching: {
                ...
                hatching_10: data.hatching_time_10,
                hatching_40: data.hatching_time_40,
            ...
            breeding: {
                ...
                breeding_10: data.breeding_time_10,
                breeding_40: data.breeding_time_40,
